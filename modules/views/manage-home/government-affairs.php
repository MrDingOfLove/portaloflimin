...
<div class="content">
	<div class="content-left float-left">
		<ul>
			...
			<li class="list-item list-item-active"><a href="<?php echo Url::to(['manage-home/government-affairs']); ?>">政务公开</a></li>
		...
		<div class="content-right float-right">
			<table>
				...
				<tr>
					...
					<td class="new-edit"><a href="<?php echo Url::to(['manage-home/government-affairs-edit','id'=>$artcle->id,'page'=>$page,'per_page'=>$per_page]); ?>">编辑</a><a style="cursor: pointer; ?>" onclick = "isDelete('<?php echo Url::to(['manage-home/government-affairs-delete','id'=>$artcle->id,'page'=>$page,'per_page'=>$per_page]);?>')">删除</a></td>
				</tr>
				<?php endforeach?>
			</table>
		</div>
		...
		<div class="show-content float-right" id="article-edit">
			<div class="content-right float-right">
			    ...
			    <div class="title_content">
			    	<a style="float: right;" href="<?php echo Url::to(['manage-home/government-affairs','page'=>$page,'per_page'=>$per_page]); ?>">返回</a>
