...
<div class="main_content">
	<div class="content_top">
		...
		<span>News</span>
		<p class="float_right location"><img src="img/location.png" alt="">当前位置:&nbsp;&nbsp;<a href="<?php echo Url::to(['home/index']); ?>">首页</a>><span>行政动态</span></p>
	</div>
	<div class="content_middle">
		<div class="content_left">
			<ul class="nav_list">
				...
				<li  class="selected"><a href="<?php echo Url::to(['news-center/dp']); ?>">行业动态</a></li>
			...
			<div class="content_page">
				<?php foreach ($articles as $article):?>
					<div class="article_lists">
						...
						<a href="<?php echo Url::to(['news-center/dp-detial','id'=>$article->id]); ?>">
